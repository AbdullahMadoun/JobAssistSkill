            ...
            for link in job_links:
                ...
                try:
                    ...
                    if href and '/jobs/view/' in href:
                        ...
                        # SMART: Extract company name from the parent container if available
                        raw_company = await link.locator('xpath=./..//span[contains(@class, "company")]').first.get_attribute('innerText')
                        if not raw_company:
                            raw_company = await link.locator('xpath=./..//div[contains(@class, "company")]').first.get_attribute('innerText')
                        
                        company_name = MetadataCleaner.clean_company_name(raw_company)
